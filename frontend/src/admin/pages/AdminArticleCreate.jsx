...
export default function AdminArticleCreate({
  redirectPath = "/admin/articles/pending",
}) {
    ...
    <div className="max-w-4xl mx-auto p-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Use this page to create a new article.
          </CardDescription>
        </CardHeader>
                    ...
                    {image ? (
                      ...
                      <div className="text-center text-muted-foreground">
                        ...
                        <div className="text-xs mt-1">
                          Primary article image (large hero)
                        </div>
                      </div>
                    )}
                  ...
                  >
                    {imageCard ? (
                      ...
                      <div className="text-center text-muted-foreground">
                        ...
                        <div className="text-xs mt-1">
                          Small thumbnail used in article lists and cards.
                        </div>
                      </div>
                    )}
