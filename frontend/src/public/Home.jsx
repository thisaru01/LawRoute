    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:py-14">
      <section className="grid gap-10 lg:grid-cols-2 lg:items-center">
        <div className="space-y-5">
          <p className="text-sm font-semibold text-slate-700">Legal help, made simple</p>
          ...
          <p className="text-pretty text-base leading-7 text-slate-700">
            LawRoute helps citizens find the right legal support and helps lawyers manage consultations and case
          ...
          <dl className="grid grid-cols-3 gap-4 pt-4">
            <div className="rounded-lg border border-slate-200 bg-white p-4">
              <dt className="text-xs font-medium text-slate-600">Verified profiles</dt>
              <dd className="mt-1 text-lg font-semibold text-slate-900">Lawyers</dd>
            </div>
            <div className="rounded-lg border border-slate-200 bg-white p-4">
              <dt className="text-xs font-medium text-slate-600">Structured</dt>
              <dd className="mt-1 text-lg font-semibold text-slate-900">Cases</dd>
            </div>
            <div className="rounded-lg border border-slate-200 bg-white p-4">
              <dt className="text-xs font-medium text-slate-600">Secure</dt>
              <dd className="mt-1 text-lg font-semibold text-slate-900">Documents</dd>
            </div>
          </dl>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <div className="space-y-4">
            <div className="rounded-lg bg-slate-50 p-4">
              ...
              <p className="mt-1 text-sm text-slate-700">Choose what you want to do first:</p>
            </div>
            ...
            <div className="grid gap-3">
              ...
              >
                ...
                <p className="mt-1 text-sm text-slate-700">Request legal guidance and track your consultation.</p>
              </a>
              <a
                href="#"
                className="group rounded-lg border border-slate-200 bg-white p-4 hover:bg-slate-50"
              >
                <p className="text-sm font-semibold text-slate-900">I’m a lawyer</p>
      ...
      <section className="mt-12 grid gap-4 sm:grid-cols-3">
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          <h2 className="text-sm font-semibold text-slate-900">Find the right fit</h2>
          <p className="mt-2 text-sm leading-6 text-slate-700">
            Search by expertise and connect with professionals that match your needs.
          </p>
        </div>
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          <h2 className="text-sm font-semibold text-slate-900">Keep everything organized</h2>
          <p className="mt-2 text-sm leading-6 text-slate-700">
            Cases, meetings, and documents stay together in a single workflow.
          </p>
        </div>
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          <h2 className="text-sm font-semibold text-slate-900">Learn as you go</h2>
          <p className="mt-2 text-sm leading-6 text-slate-700">
