...
export default function CivilIssueSubmitSuccess({ countdown, onRedirectNow }) {
  return (
    <div className="space-y-4 px-4 py-8 text-center animate-in fade-in zoom-in duration-500 sm:space-y-6 sm:py-12">
      ...
      <div className="space-y-1 sm:space-y-2">
        <h3 className="text-xl font-bold text-slate-900 sm:text-2xl">Issue Submitted Successfully</h3>
        <p className="text-sm text-slate-500 sm:text-base">Your report has been received and assigned to the relevant authority.</p>
      </div>
